...
public class spinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(spinnerActivity.this,
        ...
        ArrayAdapter<String> y_arrayAdapter = new ArrayAdapter<String>(spinnerActivity.this,
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if(p.equals("Select Program") || y.equals("Select Year"))
                    ...
                    Intent timetablePage = new Intent(getApplicationContext(), ScheduleActivity.class);
                    timetablePage.putExtra("loc", loc);
